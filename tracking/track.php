...
<cms:template title='Tracking' clonable='1' parent="_track_" order="1" >
	<cms:editable name='userid' label='User Id' type='relation' has='one' masterpage='users/index.php' order='1' />
	<cms:editable name='user_latitude' label='Latitude' type='text' order='2' />
	<cms:editable name='user_longitude' label='Longitude' type='text' order='3' />
	<cms:editable name='status' label='Status' type='text' order='4' />
	<cms:editable name='sosid' label='SOS Id' type='relation' has='one' masterpage='select-sos.php' order='5' />
</cms:template>
...
<cms:set sosid_tracking="<cms:gpc 'sosid' method='get' />" scope='global' />
...
<html>
	...
	<body>
		...
		<script>
	        ...
	        var markersOnMap = [
	        	<cms:pages masterpage='tracking/track.php' sosid=sosid_tracking>
	        	{
