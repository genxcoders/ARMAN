...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="fl_window">
                <!-- <div>
                    <img src="http://api.androidhive.info/images/firebase_logo.png" width="200" alt="Firebase"/>
                </div> -->
                <br/>
                <?php if ($json != '') { ?>
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    ...
                    <input type="text" id="title" name="k_page_title" class="pure-input-1-2" placeholder="Enter title">

                    <label for="message">Message</label>
                    <textarea class="pure-input-1-2" rows="5" name="message" id="message" placeholder="Notification message!"></textarea>

                    <label for="title">Train No</label>
                    <input type="text" id="" name="" class="pure-input-1-2" placeholder="Enter train">
