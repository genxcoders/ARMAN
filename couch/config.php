<?php
    ...
    define( 'K_DB_NAME', 'arman' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'arman' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'arman' );
    // 7.
...
// Max Upload Size Setting
    ...
    @ini_set( 'upload_max_filesize' , '25MB' );
